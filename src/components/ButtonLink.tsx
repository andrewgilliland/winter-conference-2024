...
const ButtonLink = ({ backgroundColor = "bg-gray-800" }: ButtonLinkProps) => {
  return (
    <div className="relative">
      <div className="absolute border-2 border-white w-full h-full bottom-0" />
      <button
        className={`${backgroundColor} border-2 border-white px-[22px] py-2.5 max-w-[375px] transform transition-transform hover:-translate-x-1 hover:-translate-y-1`}
      >
