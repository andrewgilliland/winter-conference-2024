  ...
  return (
    ...
    >
      ...
      <div
        ...
        } border-green-300 mx-4 md:mx-8 lg:mx-0 -mt-9 lg:mt-0 pt-4 lg:pt-0 px-6 xl:px-16 pb-9 lg:pb-0 gap-2 xl:gap-5 max-w-[280px] md:max-w-none lg:h-[200px] xl:h-[230px] shadow`}
      >
